...
export default function Services() {
  return (
    <div className="services-wrapper grid md:grid-cols-2 gap-4 justify-self-center">
      <p className="font-mono text-sm text-[var(--accent)] md:col-span-2 -mb-2">
        {"// services"}
      </p>
      <div className="basis-1/2 sm:order-1 order-1">
        <Card variant="outlined" sx={cardSx}>
          <CardContent className="p-4 items-center">
            ...
            <Typography
              level="title-lg"
              sx={{ color: "var(--accent)", fontFamily: "var(--font-mono)" }}
              className="mb-3 font-mono"
            >
              Empowering Businesses with Cloud Solutions
            </Typography>
            <Typography
              sx={{ color: "var(--fg-muted)", fontFamily: "var(--font-mono)" }}
              className="font-mono"
            >
              I am skilled in leveraging cloud technologies to help businesses
              seamlessly transition from on-premises infrastructure to the
              cloud. With a focus on scalability, security, and efficiency, I
              design and implement tailored cloud solutions that align with
              organizational goals. My expertise includes cloud migration
              strategies, optimizing existing architectures, and building
              innovative solutions to support business growth and agility in a
      ...
      <div className="basis-1/2 sm:order-2 order-2">
        <Card variant="outlined" sx={cardSx}>
          <CardContent className="p-4 items-center">
            <Image
              src="/images/services/application.png"
              width={100}
              height={100}
              alt="application"
            />
        ...
        <Card variant="outlined" sx={cardSx}>
          <CardContent className="p-4 items-center">
            ...
            <Typography
              sx={{ color: "var(--fg-muted)", fontFamily: "var(--font-mono)" }}
            >
              I provide cloud-based solutions for small businesses. I help
              businesses deploy websites, scale applications, and optimize
              performance with minimal infrastructure management. My services
              include cloud hosting consultation, site deployment, code reviews,
              and performance optimization to ensure reliable, cost-effective
              solutions for growth and digital transformation. Additionally, I
              offer consultations on code reviews, performance optimization, and
              best practices for building and maintaining web applications. My
              goal is to ensure that small businesses can access reliable,
              cost-effective solutions that support their growth and digital
              transformation.
            </Typography>
          </CardContent>
        </Card>
