...
export default function Contact() {
	return (
		<div className="flex flex-col gap-6 md:p-2">
			<p className="font-mono text-sm text-[var(--accent)] text-center">{"// contact"}</p>
			<div className="flex max-md:flex-col items-center justify-center text-center gap-4">
				<Image
					...
					unoptimized
				/>
				<Typography level="h4" sx={{ color: 'var(--fg)' }} className="text-lg font-semibold">
				...
				<div className="flex justify-center items-center flex-1 w-full max-w-sm">
					<Card sx={{ width: '100%', boxShadow: 'lg', ...cardSx }}>
						<CardContent className="flex flex-col lg:flex-row items-center gap-4">
							...
							/>
							<Typography level="h1" sx={{ color: 'var(--fg)', fontFamily: 'var(--font-mono)' }} className="text-center lg:text-left">
								Agam Mishra
							</Typography>
						</CardContent>
						<CardContent className="socials flex flex-col gap-2 pt-4">
							...
							<Typography level="body-md" sx={{ color: 'var(--fg-muted)' }}>
								<GitHub />{' '}
								<Link href="https://github.com/agam-mishra/" style={{ color: 'var(--accent)' }}>agam-mishra</Link>
							</Typography>
							<Typography level="body-md" sx={{ color: 'var(--fg-muted)' }}>
								<LinkedIn />{' '}
								<Link href="https://www.linkedin.com/in/agammishra" style={{ color: 'var(--accent)' }}>
									Agam Mishra
								</Link>
							</Typography>
							<Typography level="body-md" sx={{ color: 'var(--fg-muted)' }}>
								<Instagram />{' '}
								<Link href="https://www.instagram.com/agam_mishra" style={{ color: 'var(--accent)' }}>
									@agam_mishra
								</Link>
							</Typography>
							<Typography level="body-md" sx={{ color: 'var(--fg-muted)' }}>
								<Twitter />{' '}
								<Link href="https://x.com/agammishra10" style={{ color: 'var(--accent)' }}>@agammishra10</Link>
							</Typography>
						</CardContent>
					</Card>
				</div>
								...
								<div className="text-right">
									<Button
										...
										sx={{
											...
											color: 'var(--bg)',
											fontFamily: 'var(--font-mono)',
											'&:hover': { backgroundColor: 'var(--accent)', opacity: 0.85 },
										}}
									>
										Send Message
									</Button>
