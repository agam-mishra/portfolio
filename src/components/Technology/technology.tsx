...
export default function Technology() {
	return (
		<div className="technology-wrapper flex flex-col gap-4 md:gap-10">
			<p className="font-mono text-sm text-[var(--accent)]">{"// stack"}</p>
			<div className="description md:text-lg text-[var(--fg-muted)] leading-relaxed">
			...
			<div className="icons flex gap-2 lg:gap-8 flex-wrap text-xs md:text-base lg:text-base">
				<div className="flex flex-row gap-2 justify-center items-center bg-[var(--bg-raised)] border border-[var(--border)] p-2 rounded font-mono text-[var(--fg)]">
